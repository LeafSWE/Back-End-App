...
INSERT INTO "Edge" VALUES (0, 0, 8, 1, 'coordinate', 1, 'Sali 1 piano di scale', 'longDesc'),
	-- Edge dal ROI 8 al 0
	(2, 8, 0, 1, 'coordinate', 1, 'Scendi 1 piano di scale', 'longDesc'),
	(3, 1, 9, 1, 'coordinate', 1, 'Sali 1 piano di scale', 'longDesc'),
	(4, 9, 1, 1, 'coordinate', 1, 'Scendi 1 piano di scale', 'longDesc'),
	(5, 2, 10, 1, 'coordinate', 1, 'Sali 1 piano di scale', 'longDesc'),
	(6, 10, 2, 1, 'coordinate', 1, 'Scendi 1 piano di scale', 'longDesc'),
	(7, 3, 11, 1, 'coordinate', 1, 'Sali 1 piano di scale', 'longDesc'),
	(8, 11, 3, 1, 'coordinate', 1, 'Scendi 1 piano di scale', 'longDesc'),

-- Ascensore piano terra - 1° piano),
	(9, 0, 4, 1, 'coordinate', 2, 'Sali 1 piano con l''ascensore', 'longDesc'),
	(10, 4, 0, 1, 'coordinate', 2, 'Scendi 1 piano con l''ascensore', 'longDesc'),
	(11, 1, 5, 1, 'coordinate', 2, 'Sali 1 piano con l''ascensore', 'longDesc'),
	(12, 5, 1, 1, 'coordinate', 2, 'Scendi 1 piano con l''ascensore', 'longDesc'),
	(13, 2, 6, 1, 'coordinate', 2, 'Sali 1 piano con l''ascensore', 'longDesc'),
	(14, 6, 2, 1, 'coordinate', 2, 'Scendi 1 piano con l''ascensore', 'longDesc'),
	(15, 3, 7, 1, 'coordinate', 2, 'Sali 1 piano con l''ascensore', 'longDesc'),
	(16, 7, 3, 1, 'coordinate', 2, 'Scendi 1 piano con l''ascensore', 'longDesc'),

-- Dalle scale al corridoio
	(17, 8, 4,0, 'coordinate', 0, 'Apri la porta di fronte a te e svolta a destra', 'longDesc'),
	(18, 4, 8,0, 'coordinate', 0, 'Oltrepassa la prima porta di fronte a te, svolta a sinistra ed oltrepassa la seconda porta', 'longDesc'),
	(19, 9, 5, 0, 'coordinate', 0, 'Apri la porta di fronte a te e svolta a sinistra', 'longDesc'),
	(20, 5, 9,0, 'coordinate', 0, 'Oltrepassa la prima porta di fronte a te, svolta a destra ed oltrepassa la seconda porta', 'longDesc'),
	(21, 10, 6,0, 'coordinate', 0, 'Apri la porta di fronte a te e svolta a destra', 'longDesc'),
	(22, 6, 10,0, 'coordinate', 0, 'Oltrepassa la prima porta di fronte a te, svolta a sinistra ed oltrepassa la seconda porta', 'longDesc'),
	(23, 11, 7,0, 'coordinate', 0, 'Apri la porta di fronte a te e svolta a sinistra', 'longDesc'),
	(24, 7, 11,0, 'coordinate', 0, 'Oltrepassa la prima porta di fronte a te, svolta a destra ed oltrepassa la seconda porta', 'longDesc'),

-- Corridoi
	(25, 4, 7,0, 'coordinate', 0, 'Percorri il corridoio', 'longDesc'),
	(26, 7, 4,0, 'coordinate', 0, 'Percorri il corridoio', 'longDesc'),
	(27, 5, 6,0, 'coordinate', 0, 'Percorri il corridoio', 'longDesc'),
	(28, 6, 5,0, 'coordinate', 0, 'Percorri il corridoio', 'longDesc');
