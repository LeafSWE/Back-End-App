...
-- Collegamenti tra le entrate
	(28, 0, 1, 20, '0', 0, 'Raggiungi l''entrata della torre B', 'Tieni l''ascensore alla tua sinistra, apri la porta ed avanza verso l''esterno. Alla tua sinistra dovresti vedere via Trieste, alla tua destra una ringhiera che dà su di un chiostro interrato. Raggiungi la porta della torre B di fronte a te.'),
	(29, 1, 0, 20, '0', 0, 'Raggiungi l''entrata della torre A', 'Tieni l''ascensore alla tua destra, apri la porta ed avanza verso l''esterno. Alla tua destra dovresti vedere via Trieste, mentre alla tua sinistra dovresti vedere la ringhiera che dà su un chiostro interrato. Raggiungi la porta della torre A di fronte a te.'),
	(30, 1, 2, 20, '0', 0, 'Raggiungi l''entrata della torre C', 'Tieni la bacheca degli annunci alla tua tua sinistra, apri la porta e avanza verso l''esterno. Alla tua sinistra dovresti vedere un parcheggio mentre alla tua destra una ringhiera che dà su di un chiostro interrato. Raggiungi la porta della torre C di fronte a te.'),
	(31, 2, 1, 20, '0', 0, 'Raggiungi l''entrata della torre B', 'Tieni la lavagna alla tua destra, apri la porta e avanza verso l''esterno. Di fronte a te dovresti vedere due porte, alla tua sinistra dovresti vedere la ringhiera che dà su di un chiostro interrato, alla tua destra dovresti vedere un parcheggio. Raggiungi la porta più a sinistra.'),
	(32, 2, 3, 20, '0', 0, 'Raggiungi l''entrata della torre D', 'Tieni l''ascensore e la porta verde alla tua sinistra, apri la porta ed avanza verso l''esterno. Alla tua sinistra dovresti vedere dei portabiciclette e un pezzo di prato, mentre alla tue destra sempre dei portabiciclette e una ringhiera che dà su di un chiostro interrato. Raggiungi la porta della torre D di fronte a te.'),
	(33, 3, 2, 20, '0', 0, 'Raggiungi l''entrata della torre C', 'Tieni l''ascensore alla tua destra, apri la porta ed avanza verso l''esterno. Davanti a te dovresti vedere dei portabiciclette, alla tua destra degli altri portabiciclette e un fazzoletto di prato, alla tua sinistra la ringhiera che dà su di un chiostro interrato e dei portabiciclette. Raggiungi la porta della torre C di fronte a te.'),
	(34, 0, 3, 20, '0', 0, 'Raggiungi l''entrata della torre D', 'Alla tua destra dovresti vedere la segreteria della Torre Archimede ed alcune cassette delle lettera. Apri la porta ed avanza davanti ed avanza verso l''esterno. Di fronte a te dovresti vedere due porte, alla tua destra un parcheggio e l''edificio dove si svolgono I corsi di economia, alla tua sinistra una ringhiera che dà su di un chiostro interrato. Raggiungi la porta della torre D, qualla più a sinistra tra le due porte di fronte a te.'),
	(35, 3, 0, 20, '0', 0, 'Raggiungi l''entrata della torre A', 'Alla tua sinistra dovresti vedere una lavagna. Apri la porta e avanza. Davanti a te dovresti vedere 2 porte, alla tua destra una ringhiera che dà su di un chiostro interrato, alla tua sinistra un parcheggio e l''edificio dove si svolgono I corsi di economia. Raggiungi la porta della torre A di fronte a te.');
